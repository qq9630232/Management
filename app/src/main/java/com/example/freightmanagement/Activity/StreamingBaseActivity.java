...
//            }
        ...
        // video misc
        mProfile.setEncodingOrientation(true ? StreamingProfile.ENCODING_ORIENTATION.PORT : StreamingProfile.ENCODING_ORIENTATION.LAND);
        mProfile.setEncoderRCMode(true ? StreamingProfile.EncoderRCModes.QUALITY_PRIORITY : StreamingProfile.EncoderRCModes.BITRATE_PRIORITY);
//            mProfile.setBitrateAdjustMode( StreamingProfile.BitrateAdjustMode.Auto);
        mProfile.setFpsControllerEnable(true);
//            mProfile.setYuvFilterMode(StreamingProfile.YuvFilterMode.values()[1]);
