...
public class CommonVideoActivity extends BaseActivity {
    ...
    private static final String TAG = CommonVideoActivity.class.getSimpleName();
    ...
    public void onClickSwitchScreen(View v) {
        ...
        switch (mVideoView.getDisplayAspectRatio()) {
            case PLVideoTextureView.ASPECT_RATIO_ORIGIN:
                Utils.showToastTips(CommonVideoActivity.this, "Origin mode");
                break;
            case PLVideoTextureView.ASPECT_RATIO_FIT_PARENT:
                Utils.showToastTips(CommonVideoActivity.this, "Fit parent !");
                break;
            case PLVideoTextureView.ASPECT_RATIO_PAVED_PARENT:
                Utils.showToastTips(CommonVideoActivity.this, "Paved parent !");
                break;
            case PLVideoTextureView.ASPECT_RATIO_16_9:
                Utils.showToastTips(CommonVideoActivity.this, "16 : 9 !");
                break;
            case PLVideoTextureView.ASPECT_RATIO_4_3:
                Utils.showToastTips(CommonVideoActivity.this, "4 : 3 !");
                break;
            default:
                break;
        }
        ...
        public void onInfo(int what, int extra) {
            ...
            switch (what) {
                ...
                case PLOnInfoListener.MEDIA_INFO_VIDEO_RENDERING_START:
                    Utils.showToastTips(CommonVideoActivity.this, "First video render time: " + extra + "ms");
                    break;
        ...
        public boolean onError(int errorCode) {
            ...
            switch (errorCode) {
                case PLOnErrorListener.ERROR_CODE_IO_ERROR:
                     ...
                     */
                    Utils.showToastTips(CommonVideoActivity.this, "IO Error !");
                    return false;
                case PLOnErrorListener.ERROR_CODE_OPEN_FAILED:
                    Utils.showToastTips(CommonVideoActivity.this, "failed to open player !");
                    break;
                case PLOnErrorListener.ERROR_CODE_SEEK_FAILED:
                    Utils.showToastTips(CommonVideoActivity.this, "failed to seek !");
                    return true;
                default:
                    Utils.showToastTips(CommonVideoActivity.this, "unknown error !");
                    break;
            }
            finish();
            return true;
    ...
    private PLOnCompletionListener mOnCompletionListener = new PLOnCompletionListener() {
        ...
        public void onCompletion() {
            ...
            Utils.showToastTips(CommonVideoActivity.this, "Play Completed !");
            finish();
        }
    };
