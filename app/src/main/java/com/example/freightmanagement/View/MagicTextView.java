...
public class MagicTextView extends TextView {
    ...
    public void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            String typefaceName = a.getString(R.styleable.MagicTextView_m_typeface);
            if (typefaceName != null) {
                Typeface tf = Typeface.createFromAsset(getContext().getAssets(), String.format("fonts/%s.ttf", typefaceName));
                setTypeface(tf);
            }

            if (a.hasValue(R.styleable.MagicTextView_m_foreground)) {
                Drawable foreground = a.getDrawable(R.styleable.MagicTextView_m_foreground);
                if (foreground != null) {
                    this.setForegroundDrawable(foreground);
                } else {
                    this.setTextColor(a.getColor(R.styleable.MagicTextView_m_foreground, 0xff000000));
                }
            }
            ...
            if (a.hasValue(R.styleable.MagicTextView_m_strokeColor)) {
                float strokeWidth = a.getFloat(R.styleable.MagicTextView_m_strokeWidth, 1);
                int strokeColor = a.getColor(R.styleable.MagicTextView_m_strokeColor, 0xff000000);
                float strokeMiter = a.getFloat(R.styleable.MagicTextView_m_strokeMiter, 10);
                Join strokeJoin = null;
                switch (a.getInt(R.styleable.MagicTextView_m_strokeJoinStyle, 0)) {
                    case (0):
